//My own design
//I have not seen this online yet, it was inspired by the menger sponge
...
class Box {
  ...
  Box[] iterate() {
    Box[]news=new Box[7];
    float ns=size/3;
    news[0]=new Box(ns,ns,ns,ns);
    news[1]=new Box(0,ns,ns,ns);
    news[2]=new Box(ns,0,ns,ns);
    news[3]=new Box(ns,ns,0,ns);
    news[4]=new Box(2*ns,ns,ns,ns);
    news[5]=new Box(ns,2*ns,ns,ns);
    news[6]=new Box(ns,ns,2*ns,ns);
